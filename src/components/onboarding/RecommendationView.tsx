    ...
    <div className="card flex flex-col gap-4">
      <div className="flex items-center gap-2">
        ...
        <div className="leading-tight">
          <div className="text-sm font-semibold">Recommended model</div>
          {comparabilityGroup && (
      ...
      {selectable.length > 0 ? (
        ...
        <div className="rounded-md border border-unrated/40 bg-unrated/10 px-3 py-2 text-sm text-unrated">
          ...
          no CI agent. Try different inputs.
        </div>
      )}
      ...
      {/* baseline */}
      <div className="rounded-md border border-border bg-panel-2 px-3 py-2 text-xs">
      ...
      <div className="flex flex-col gap-2 border-t border-border pt-4">
        ...
        <div className="flex flex-wrap gap-2">
          <input
            ...
            className="min-w-0 flex-1 rounded-md border border-border bg-panel-2 px-3 py-2 text-sm text-gray-100 placeholder:text-faint focus:border-accent/50 focus:outline-none"
          />
          <button
            type="button"
    ...
    <li>
      ...
      >
        ...
        <span className="min-w-0 flex-1">
          ...
          <span className="text-xs text-faint">{option.vendor}</span>
        </span>
        <span className="shrink-0 text-right">
          <span className="num block text-sm text-signal">
