...
// heading; it FETCHES it from Driftplain at run time (GET /agent-config), so editing
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="leading-tight">
          ...
          <div className="text-sm text-faint">
            ...
            agent reads them from Driftplain on every run, so you can change them later
